...
XDC --datadir /work/xdcchain-testnet --networkid 786 -port 30303 --rpc --rpccorsdomain "*" --rpcaddr 0.0.0.0 --rpcport 8545  --rpcvhosts "*"  --mine --etherbase "0x6f72461814416d367Cdab838d083fB17c592098E" --verbosity 3 --ws --wsaddr=0.0.0.0 --wsport 8556 --wsorigins "*" 2>&1 >>/work/xdcchain-testnet/xdc.log | tee --append /work/xdcchain-testnet/xdc.log
